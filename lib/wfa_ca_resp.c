...
//   wfaCtrlSend(gCaSockfd, (char *)gRespStr, strlen(gRespStr));
...
{
    int done = 0;
    dutCmdResponse_t* verifyResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    int done = 0;
    dutCmdResponse_t* connectedResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    int done = 0;
    dutCmdResponse_t* getIpConfigResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    int done = 0;
    dutCmdResponse_t* getverResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    dutCmdResponse_t* infoResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
    int done = 0;
...
{
    int done = 0;
    dutCmdResponse_t* agtConfigResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
int wfaTrafficAgentSendResp(char* cmdBuf)
{
    ...
    int len = ptlv->len;
    int numStreams;
    char* statResp = cmdBuf + WFA_TLV_HDR_LEN;
    dutCmdResponse_t* curResp = (dutCmdResponse_t*) statResp;

    DPRINT_INFO(WFA_OUT, "Entering wfaTrafficAgentSendResp ...\n");

    numStreams = len / (8 + sizeof(tgStats_t));
    printf("total %i streams\n", numStreams);

    if(numStreams == 0) {
        dutCmdResponse_t* errorResp = (dutCmdResponse_t*) statResp;
...
int wfaTrafficAgentRecvStopResp(char* cmdBuf)
{
    ...
    int i = 0;
    char copyBuf[64];
    char* dutRsp = cmdBuf + WFA_TLV_HDR_LEN;
    wfaTLV* ptlv = (wfaTLV*) cmdBuf;
    int len = ptlv->len;
    int numStreams = len / (8 + sizeof(tgStats_t));
    dutCmdResponse_t* curResp = (dutCmdResponse_t*) dutRsp;

    printf("total %i streams\n", numStreams);

    if(numStreams == 0) {
        dutCmdResponse_t* errorResp = (dutCmdResponse_t*) dutRsp;
...
{
    int done = 0;
    dutCmdResponse_t* staPingResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    int done = 0;
    dutCmdResponse_t* stpResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    int done = 0;
    dutCmdResponse_t* getmacResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    int done = 0;
    dutCmdResponse_t* getBssidResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    int done = 0;
    dutCmdResponse_t* setEncryptionResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
#if 0
int wfaStaReAssociateResp(char* cmdBuf)
{
    int done = 0;
    dutCmdResponse_t* assocResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    int done = 0;
    dutCmdResponse_t* getStatsResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    int done = 1;
    dutCmdResponse_t* devInfoResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    int done = 0, i;
    dutCmdResponse_t* devListIfResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
    caDeviceListIFResp_t* ifResp = &devListIfResp->cmdru.ifList;

    DPRINT_INFO(WFA_OUT, "status: %u\n", devListIfResp->status);
...
{
    int done = 0;
    dutCmdResponse_t* uploadResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    int done = 0;
    dutCmdResponse_t* p2pDevAddResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    int done = 0;
    dutCmdResponse_t* p2pResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    int done = 0;
    dutCmdResponse_t* setwmmResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    int done = 0;
    dutCmdResponse_t* wfdResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    int done = 0;
    caStaCliCmdResp_t* staCliCmdResp = (caStaCliCmdResp_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    int done = 0;
    dutCmdResponse_t* execActionResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
{
    int done = 0;
    dutCmdResponse_t* dutResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
...
int wfaStaGetEventsResp(char* cmdBuf)
{
    int done = 0;
    dutCmdResponse_t* dutResp = (dutCmdResponse_t*)(cmdBuf + WFA_TLV_HDR_LEN);
    caStaGetEventListCmdResp_t* getEvents = &dutResp->cmdru.staGetEvents;
